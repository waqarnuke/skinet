...
{
    /// <inheritdoc />
    public partial class Postgresinitia : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortName = table.Column<string>(type: "VARCHAR", maxLength: 250, nullable: true),
                    DeliveryTime = table.Column<string>(type: "VARCHAR", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BuyerEmail = table.Column<string>(type: "VARCHAR", maxLength: 250, nullable: true),
                    ...
                    PaymentIntentId = table.Column<string>(type: "VARCHAR", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "VARCHAR", maxLength: 180, nullable: false),
                    Price = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemOrderedProductUrl = table.Column<string>(name: "ItemOrdered_ProductUrl", type: "text", nullable: true),
                    Price = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
